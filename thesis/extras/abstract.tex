...
\parbox{0.7\linewidth}{
    ...
    structure properties. Our results suggest that \JS applications typically
    allocate mostly small and short living objects and that the allocation
    behavior is more likely than C programs.
